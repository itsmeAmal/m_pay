...
List<UserPages> pageList= new ArrayList<UserPages>();
  ...
  String[] userRolesArr=userData.getUsertype().split(",");
   ...
   if(userRolesArr[j].equals("Super Agent")){
    pgSt=true;
					                                    ...
					                                    <div class="row">
						                                    ...
						                                    <div class="col-xl-6">
						                                        	<div class="card" style="height:115px">
						                                        		<div class="card-body" style="margin-top:none;padding-top:10px;padding-bottom:2px">
						                                        			<i class="fas fa-user-tie mr-3 fa-2x mb-1 " style="color:#ef6c00 ; margin-left: 25px ;"></i>										                                    
											                                     <h6 class="font-weight-bold mb-0  text-center opacity-50 "><font color="black" style="font-size:16px;"> Super Agent</font></h6>
						                                    ...
						                                    <div class="col-xl-6">
						                                        	<div class="card " style="height:115px">
																		<div class="card-body" style="margin-top:none;padding-top:10px;padding-bottom:2px">													
																				<i class="fas fa-user-lock mr-3 fa-2x mb-1" style="color:#ffa726; margin-left: 25px ;"></i>
											                                    <h6 class="font-weight-semibold mb-0  text-center"><font color="black"><%= userType.getDistributorCount()%></font></h6>
											                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 "><font color="black" style="font-size:12px;">Distributor</font></h6>
						                                    ...
						                                    <div class="col-xl-6">
						                                        <div class="card" style="height:115px">
																	<div class="card-body" style="margin-top:none;padding-top:10px;padding-bottom:2px">													
									                                    ...
									                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 "><font color="black" style="font-size:12px;">Agent</font></h6>
									                                   <!--  <span class=" font-weight-bold text-muted ml-2 opacity-50"><font color="black">Distributors</font></span> -->					                                    																
																	</div>
											...
											<div class="card bg-teal-300">
												<div class="card-body">
			                                        ...
			                                        <div class= "class2">
			                                            ...
			                                            <span class=" mb-0  ml-1" style="font-size: 15px; align-content: center; margin-top: 20px;"> <%= transactionSummaryByAccNo.getAllTransactionAmount() %> </span>                                          
			                                           </div>
													</div>
			                                       </div>
												</div>
											...
											<div class="card bg-pink-300">
												...
												<div> 
			                                        ...
			                                        <!-- <h5 id="txt"></h5> --> <!-- month should generate -->                            
			                                         ...
			                                         <span class=" mb-0  ml-1" style="font-size: 13px; align-content: center; margin-top: 20px;" id="monthlyA"></span>                                                                                    
													 </div>
													 </div>
													 </div>
			                                        <div class= "class4">
						...
						//bg
						  ...
						  onSelect: function() {
                            ...
                            var month = $(this).datepicker('getDate').getMonth(); 
                               ...
                               window.location.replace("SuperAgent_page.jsp?wdate="+wdate);
