...
<%
    ...
    int timeout = session.getMaxInactiveInterval() / 6; //seconds
    int refresh = session.getMaxInactiveInterval() / 6;
    response.setHeader("Refresh", refresh + "; URL = Login_page.jsp");
    /* out.print(timeout + ","+ refresh); */
...
<%!
    ...
    int click2 = 10;
%>
<!-- to load 10 by 10 that retrive from database  -->
<%
    /* Callers obj3 = new Callers();  */
    /* List<DataDisplay> tablelist =  callobj.getTableData(clicks); */
    List<DataDisplay> tablelist = callobj.getTableData(clicks);
%>
<%
...
%>
<%
    tablelist = callobj.getTableData(clicks);
%>
...
<%
    ...
    String userAccount = userData.getD_network_account_no();
...
<%
    ...
    DailySummaryType dailySummaryType = dailySummaryTypeController.dailySummaryTypeProcessor(date);
    ...
    TransactionSummary transactionSummary = transactionSummaryController.transactionSummaryProccesor(startDateStr, endDateStr, date);
    BarChartsController barChartsController = new BarChartsController();
    AllSumaryTypeController allSumaryTypeController = new AllSumaryTypeController();
    DailySummaryType allSummaryType = allSumaryTypeController.AllSummaryTypeProcessor();
    int[] hourlySuccessTransactionArr = barChartsController.createtHourlySuccessBarChart(date);
    int[] hourlyFailTransactionArr = barChartsController.createtHourlyFailBarChart(date);
    int[] hourlyTimeoutTransactionArr = barChartsController.createtHourlyTimeoutBarChart(date);
    int[] hourlyAllTransactionArr = barChartsController.createtHourlyAllBarChart(date);

    MonthlyTransByDateController monthlyTransByDateController = new MonthlyTransByDateController();
    int[] monthlyTransactionByDate = monthlyTransByDateController.createMonthlyTransByDate(startDateStr, endDateStr);
    ...
    /* out.print(profileUpdates.size() + userAccount); */
    String reqStatus = "";


    for (int i = 0; i < profileUpdates.size(); i++) {
        reqStatus = profileUpdates.get(i).getRequestStatus();
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="card" style="height:115px">
                                                                <div class="card-body"
                                                                     style="margin-top:none;padding-top:10px;padding-bottom:2px">
                                                                    <i class="fas fa-user-tie mr-3 fa-2x mb-1 "
                                                                       style="color:#ef6c00 ; margin-left: 25px ;"></i>
                                                                    <h6 class="font-weight-semibold mb-0  text-center">
                                                                        <font color="black"><%= userType.getSuperagentCount() %>
                                                                        </font></h6>
                                                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 ">
                                                                        <font color="black" style="font-size:13px;">
                                                                            Super Agent</font></h6>
                                                                    <!--  <span class="font-weight-bold text-muted ml-0 opacity-50" style="font-size:13px"><font color="black">Super Agents</font></span> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/Super Agent Count-->
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="card " style="height:115px">
                                                                <div class="card-body"
                                                                     style="margin-top:none;padding-top:10px;padding-bottom:2px">
                                                                    <i class="fas fa-user-lock mr-3 fa-2x mb-1"
                                                                       style="color:#ffa726; margin-left: 25px ;"></i>
                                                                    <h6 class="font-weight-semibold mb-0  text-center">
                                                                        <font color="black"><%= userType.getDistributorCount() %>
                                                                        </font></h6>
                                                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 ">
                                                                        <font color="black" style="font-size:13px;">Distributor</font>
                                                                    </h6>
                                                                    <!--  <span class=" font-weight-bold text-muted ml-2 opacity-50"><font color="black">Distributors</font></span> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /Distributor Count-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="card" style="height:115px">
                                                                <div class="card-body"
                                                                     style="margin-top:none;padding-top:10px;padding-bottom:2px">
                                                                    <i class="fas fa-user-cog mr-3 fa-2x mb-1"
                                                                       style="color: #ffcc80; margin-left: 25px ;"></i>
                                                                    <h6 class="font-weight-semibold mb-0  text-center">
                                                                        <font color="black"><%= userType.getAgentCount() %>
                                                                        </font></h6>
                                                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 ">
                                                                        <font color="black" style="font-size:13px;">Agent</font>
                                                                    </h6>
                                                                    <!--  <span class=" font-weight-bold text-muted ml-2 opacity-50"><font color="black">Distributors</font></span> -->
                                                                </div>
                                                                <%-- <div class="media-body">
                                                                    <i class="fas fa-user-cog mr-3 fa-2x mb-1" style="color: #ffcc80; margin-left: 25px ;"></i>
                                                                    <h6 class="font-weight-semibold mb-0 text-center"><font color="black"> <%= userType.getAgentCount() %></font></h6>
                                                                    <span class="font-weight-bold text-muted ml-3 text-muted opacity-50"><font color="black">Agents</font></span>
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="card" style="height:115px">
                                                                <div class="card-body"
                                                                     style="margin-top:none;padding-top:10px;padding-bottom:2px">
                                                                    <i class="fas fa-users mr-3 fa-2x mb-1"
                                                                       style="color: #ffca28 ; margin-left: 25px ;"></i>
                                                                    <h6 class="font-weight-semibold mb-0  text-center">
                                                                        <font color="black"><%= userType.getSubscriberCount() %>
                                                                        </font></h6>
                                                                    <h6 class="font-weight-bold mb-0  text-center opacity-50 ">
                                                                        <font color="black" style="font-size:13px;">Subscriber</font>
                                                                    </h6>
                                                                    <!--  <span class=" font-weight-bold text-muted ml-2 opacity-50"><font color="black">Distributors</font></span> -->
                                                                </div>
                                                                <%-- <div class="media"  style="height: 75px">
                                                                    <div class="media-body">
                                                                        <i class="fas fa-users mr-3 fa-2x mb-1" style="color: #ffca28 ; margin-left: 25px ;"></i>
                                                                        <h6 class="font-weight-semibold mb-0 text-center"><font color="black"> <%= userType.getSubscriberCount() %></font></h6>
                                                                        <span class="font-weight-bold text-muted ml-2 text-muted opacity-50"><font color="black">Subscribers</font></span>
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <div class="card text-center">
                                                                <div class="card-body" style="max-height: 250px">
                                                                    ...
                                                                    <!-- Progress counter -->
                                                                    <div class="svg-center position-relative"
                                                                         id="hours-available-progress1"></div>
                                                                    <!-- /progress counter -->
                                                    ...
                                                    <div>
                                                        <div class="class1">
                                                            <div class="font-size-lg opacity-80">
                                                                <span class=" mb-0  ml-0"
                                                                      style="font-size: 15px; align-content: center;">Total Transactions </span>
                                                                <span class=" mb-0  ml-5"
                                                                      style="font-size: 25px;"> <%= transactionSummary.getAllTransactionCount()%> </span>
                                                            </div>
                                                        </div>
                                                        <div class="class2">
                                                            ...
                                                            <div class="font-size-lg opacity-80">
                                                                <span class=" mb-2  ml-1"
                                                                      style="font-size: 12px; align-content: center;"> Amount </span>
                                                                <span class=" mb-0  ml-1"
                                                                      style="font-size: 15px; align-content: center; margin-top: 20px;"> <%= transactionSummary.getAllTransactionAmount()%> </span>
                                                    ...
                                                    <div>
                                                        <div class="class3">
                                                            ...
                                                            <div class="font-size-lg opacity-80">
                                                                ...
                                                                <div id="txt" style="font-size: 19px;"></div>
                                                                <div>
                                                                    <span class=" mb-2  ml-0"
                                                                          style="font-size: 12px; align-content: center;"> Amount </span>
                                                                    <span class=" mb-0  ml-1"
                                                                          style="font-size: 13px; align-content: center; margin-top: 20px;"
                                                                          id="monthlyA"> </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="class4">
                                                            <!-- <h6 style="align-content: center;">Amount</h6> -->
                                                            <div class="font-size-lg opacity-80">
                                                                <span class=" mb-0  ml-2" style="font-size: 13px; ">Transactions </span>
                                                                <span class=" mb-0  ml-4" style="font-size: 25px;"
                                                                      id="monthlyC"> </span></div>
                                                        </div>
                                            ...
                                            <div class="card bg-blue-300">
                                                    ...
                                                    <div>
                                                        <div class="class1">
                                                            ...
                                                            <div class="font-size-lg opacity-80">
                                                                ...
                                                                <span class=" mb-0  ml-5" style="font-size: 25px;"
                                                                      id="todaytransaction">  </span></div>
                                                        </div>
                                                        <div class="class2">
                                                            <!-- <h6 style="align-content: center;">Amount</h6> -->
                                                            <div class="font-size-lg opacity-80">
                                                                <span class=" mb-5  ml-1 "
                                                                      style="font-size: 12px; align-content: center;"> Amount </span>
                                                                <span class=" mb-0  ml-1 pt-5"
                                                                      style="font-size: 16px; align-content: center; "
                                                                      id="todayamount"> </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="container-fluid">
                                                    <div id="members-online"
                                                         style="border:thin; border-color: #FFF; border-style: none;"></div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="card card-body bg-info-300">
                                        <div class="media">
                                            <div class="media-body">
                                                <span class=" font-weight-bold  font-size-lg text-muted "><font
                                                        color="white"><h6>Total Wallet Balance </h6></font></span>
                                                ...
                                                <h4 class="font-weight-semibold mb-0 opacity-75 ml-5">
                                                    ...
                                                    <%
                                                        ...
                                                        walletDetails = callobj.getWalletDetails();
                                                        String amount = "";
                                        ...
                                        <div class="signboard outer">
                                            <div class="signboard front inner anim04c" id="cale">
                                                ...
                                                <div class="signboard front">
                                                    ...
                                                    <li class="year anim04c" style="text-align: left"
                                                        style="text-align: left">
                                                        <span></span>
                                                    </li>
                                                    <ul class="calendarMain anim04c"
                                                        style="margin-left: 18px;padding: 0;border: 0;font-weight: inherit;font-style: inherit;font-size: 100%;font-family: inherit;vertical-align:middle;text-decoration: none;list-style: none;">
                                    ...
                                    <div class="card" style="max-height: 325px">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="chart-container">
                                                <div class="chart has-fixed-height" id="pie_infographic"
                                                     _echarts_instance_="ec_1571047017857"
                                                     style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;">
                                                    <div style="position: relative; overflow: hidden; width: 318px; height: 400px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
                                                        <canvas data-zr-dom-id="zr_0" width="318" height="400"
                                                                style="position: absolute; left: 0px; top: 0px; width: 318px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                                                    </div>
                                                    <div style="position: absolute; display: none; border-style: solid; white-space: nowrap; z-index: 9999999; transition: left 0.4s cubic-bezier(0.23, 1, 0.32, 1) 0s, top 0.4s cubic-bezier(0.23, 1, 0.32, 1) 0s; background-color: rgba(0, 0, 0, 0.75); border-width: 0px; border-color: rgb(51, 51, 51); border-radius: 4px; color: rgb(255, 255, 255); font: 13px/20px Roboto, sans-serif; padding: 10px 15px; left: 317px; top: 0px;"></div>
                                                </div>
                ...
                <div class="card-body">
                    <table class="table datatable-basic table-striped ">
                        ...
                        <tr>
                            ...
                            <td><%=tablelist.get(i).getT_id()%>
                            </td>
                            <td><%=tablelist.get(i).getDate()%>
                            </td>
                            <td><%=accfrom%>
                            </td>
                            <td><%=accto%>
                            </td>
                            <td><%=tablelist.get(i).getType()%>
                            </td>
                            <td><%=tablelist.get(i).getAmount()%>
                            </td>
                            <td><%=tablelist.get(i).getStatus()%>
                            </td>
						...
						<span style="float:right;margin-left:5px;">
							<form id="idForm" action="" method="post">
								<input type="hidden" name="integer" value="1"/>
								 <input id="front" type="submit" class="btn btn-primary" value="Next"
                                        onclick="check2()"/>
							</form>
						</span>
            ...
            $("#datepicker").datepicker({
                ...
                onSelect: function () {
                    ...
                    if(wdate!=null){
                       ...
                       dailySummaryStatus = dailySummaryStatusController.dailyStatusProcessor(wdate);
                       dailySummaryType = dailySummaryTypeController.dailySummaryTypeProcessor(wdate);
                          transactionSummary = transactionSummaryController.transactionSummaryProccesor(wdate1,wdate2,wdate);
                           hourlySuccessTransactionArr = barChartsController.createtHourlySuccessBarChart(wdate);
                       hourlyFailTransactionArr = barChartsController.createtHourlyFailBarChart(wdate);
                       hourlyTimeoutTransactionArr = barChartsController.createtHourlyTimeoutBarChart(wdate);
                       hourlyAllTransactionArr = barChartsController.createtHourlyAllBarChart(wdate);
                       monthlyTransactionByDate = monthlyTransByDateController.createMonthlyTransByDate(wdate1,wdate2);

                      System.out.print(wdate1 +"...."+ wdate2);
                    }
...
<script type="text/javascript">
        ...
        if ($(element).length > 0) {
            ...
            function mousemove() {
                ...
                if (mousex >= (d3Container.node().getBoundingClientRect().width - focusText.select('text').node().getBoundingClientRect().width - margin.right - margin.left)) {
                    ...
                    }).text(formatDate(d.date) + ' - ' + d.value + ' ');
                } else {
    ...
    $(document).ready(function () {
        var todayTransaction = "<%= transactionSummary.getDailyTransactionCount()%>";
        $('#todaytransaction').text(todayTransaction);
        var todayamount = "<%= transactionSummary.getDailyTransactionAmount()%>";
        $('#todayamount').text(todayamount);

        //display data for selected month
        var monthlyTransactionA = "<%=transactionSummary.getMonthlyTransactionAmount()%>";
        $("#monthlyA").text(monthlyTransactionA);
        var monthlyTransactionC = "<%= transactionSummary.getMonthlyTransactionCount()%>";
        $("#monthlyC").text(monthlyTransactionC);
    });

    $(document).ready(function () {

        var success_count_js = "<%=dailySummaryStatus.getSuccessCount()%>";
        var success_percentage_js = "<%=dailySummaryStatus.getSuccessPer()%>";
        var fail_count_js = "<%= dailySummaryStatus.getFailCount()%>";
        var fail_percentage_js = "<%=dailySummaryStatus.getFailPer()%>";
        var timeout_count_js = "<%=dailySummaryStatus.getTimeoutCount()%>";
        var timeout_percentage_js = "<%=dailySummaryStatus.getTimeoutPer()%>";
                ...
                pie_infographic.setOption({
                    ...
                    series: [
...

                        {
                            ...
                            data: [
                                {
                                    value:  <%= dailySummaryType.getCashinCount()%>,
                                    name: 'Cash In'
                                },
                                {
                                    value:  <%= 100-dailySummaryType.getCashinCount()%>,
                                    name: '',
...

                        {
                            ...
                            data: [
                                {
                                    value:  <%= dailySummaryType.getCashoutCount()%>,
                                    name: 'Cash Out'
                                },
                                {
                                    value: <%= 100-dailySummaryType.getCashoutCount()%>,
                                    name: 'invisible',
                                    silent: false,
                                    itemStyle: placeHolderStyle
                                }
...

                        {
                            ...
                            data: [
                                {
                                    value:<%= dailySummaryType.getTopupCount()%>,
                                    name: 'Mobile Top Up'
                                },
                                {
                                    value:  <%= 100-dailySummaryType.getTopupCount()%>,
                                    name: 'invisible',
                                    itemStyle: placeHolderStyle
                                }
                            ]
                        },
                        {
                            ...
                            data: [
                                {
                                    value:  <%= dailySummaryType.getFundCount()%>,
                                    name: 'Fund Transfers'
                                },
                                {
                                    value: <%= 100-dailySummaryType.getFundCount()%>,
                                    name: 'invisible',
                                    silent: false,
                                    itemStyle: placeHolderStyle
                                }
                        ...
                        },
                        {
                            ...
                            data: [
                                {
                                    value: <%= dailySummaryType.getBillCount()%>,
                                    name: 'Bill Payments'
                                },
                                {
                                    value:  <%= 100-dailySummaryType.getBillCount()%>,
                                    name: 'invisible',
                                    silent: false,
                                    itemStyle: placeHolderStyle
                                }
...
<%-- <%=String format("%02d", departmentAmount)%> --%>
