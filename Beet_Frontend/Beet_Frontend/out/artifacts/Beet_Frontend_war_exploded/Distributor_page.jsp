...
List<UserPages> pageList= new ArrayList<UserPages>();
  ...
  String[] userRolesArr=userData.getUsertype().split(",");
   ...
   if(userRolesArr[j].equals("Distributor")){
    pgSt=true;
                        ...
                        <div class="col-xl-12">
							...
							<div class="media" style="height: 75px" >
								<div class="media-body" style="color: #bbdefb">
									<i class="fas fa-user-tie mr-3 fa-3x mb-1" style="color:#ef6c00 ; margin-left: 85px;"></i>
                                <h6 class="font-weight-bold mb-0  text-center opacity-50 "><font color="black" style="font-size:16px;">Distributor</font></h6>
								</div>
								...
								<div class="card bg-pink-300">
									...
									<div> 
                                        ...
                                        <!-- <h5 id="txt"></h5> --> <!-- month should generate -->                            
                                         ...
                                         <span class=" mb-0  ml-1" style="font-size: 12px; align-content: center; margin-top: 20px;" id="monthlyA"> <%= transactionSummaryByAccNo.getMonthlyTransactionAmount() %> </span>                                                                                    
										 </div>
										 </div>
										 </div>
                                        <div class= "class4">
...
<div class="cal" style="margin-top:46px">
    ...
    <!-- main codes end -->
                            ...
                            <!-- Infographic style -->
						<div class="card" style="margin-top: 0px;  max-height: 310px">
						...
						//bg
						  ...
						  onSelect: function() {
                            ...
                            var month = $(this).datepicker('getDate').getMonth(); 
                               ...
                               window.location.replace("Distributor_page.jsp?wdate="+wdate);
