        ...
        try {
            ...
            if (resultFromWallet.equals("1")) {
                ...
                if (resultFromMinMaxRule.equals("1")) {
					...
					System.out.println("resultFromDailyTransRule: "+resultFromDailyTransRule);
...
//                    System.out.println("debitWallet: "+debitWallet.getAccNo());
                    ...
                    if (resultFromUpdateDebitWallet.equals("1")) {
                        ...
                        System.out.println("transactionTypesId: "+transactionTypesId);
                        ...
                        if (resultsFromUpdateTransSuccess2.substring(0, 1).equals("0")) {
                            ...
                            System.out.println("setTransactionId: "+transactionId2);
                            commission.setTransactionTypesId(commissionRules.getTransactionTypeId());
                            System.out.println("setTransactionTypesId: "+commissionRules.getTransactionTypeId());
